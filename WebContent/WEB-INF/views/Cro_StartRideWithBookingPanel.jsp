...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
	      ...
	      <c:if test="${nobookingfound == 1}">
	       ...
	       <div class="panel panel-info">
		      ...
		      <div class="panel-body">
		      	<form name="addridewithbooking" action="addridewithbooking">
		      		<input type="text" class="form-control form-control-md" id="bookingid" name="bookingid"/><br/>
   ...
   $(function() {
	   ...
	   $("form[name='addridewithbooking']").validate({
